  ...
  >
    <div class="relative h-[auto] w-full flex justify-center items-center">
      <div class="container relative z-[3] pt-[35%] sm:pt-[12%] lg:pt-[12%]">
        <h1 class="text-white font-extrabold text-[34px] md:text-40 xl:text-[58px] 2xl:text-[66px] lg:mx-auto md:text-center lg:w-[85%]">{{ blok.headline }}</h1>
      </div>
      <SvgImport
        type="blob-1-stroke"
        class="z-[2] home-hero__blob-figure absolute -translate-x-1/2 -translate-y-1/2 w-[320px] lg:w-[500px] xl:w-[680px] left-0 top-[90%] sm:top-[85%]"
      />
    </div>
  </section>
</template>
